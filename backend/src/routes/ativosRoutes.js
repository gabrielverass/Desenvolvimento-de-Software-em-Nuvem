...
router.post('/criarativo', criarNovoAtivo);

//rota para buscar um ativo por patrimônio, protegida por autenticação e autorização de admin.
router.get('/buscarativo/:patrimonio', buscarAtivoPorCampo);
...
router.put('/editarativo/:id', editarAtivo);

//rota para deletar um ativo, protegida por autenticação e autorização de admin.
router.delete('/deletarativo/:id', deletarAtivo);
